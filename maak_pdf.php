...
if(!empty($_POST) && $_POST['action'] == 'pdf')
{
	...
	Laat het lijken op een digitale broek voor grote jongens die we nodig hebben om onze synergieën te benutten. Digitale geletterdheid produceert en activeert uw browser snel.
	</td>
	</tr>
	</tbody>
	</table>
